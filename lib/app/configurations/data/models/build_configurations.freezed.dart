...
/// Adds pattern-matching-related methods to [BuildConfigurations].
extension BuildConfigurationsPatterns on BuildConfigurations {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _BuildConfigurations value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _BuildConfigurations() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _BuildConfigurations value)  $default,){
final _that = this;
switch (_that) {
case _BuildConfigurations():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _BuildConfigurations value)?  $default,){
final _that = this;
switch (_that) {
case _BuildConfigurations() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String baseUrl,  Environment environment)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BuildConfigurations() when $default != null:
return $default(_that.baseUrl,_that.environment);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String baseUrl,  Environment environment)  $default,) {final _that = this;
switch (_that) {
case _BuildConfigurations():
return $default(_that.baseUrl,_that.environment);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String baseUrl,  Environment environment)?  $default,) {final _that = this;
switch (_that) {
case _BuildConfigurations() when $default != null:
return $default(_that.baseUrl,_that.environment);case _:
  return null;
