...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  UserResponse from,  InviteGroupResponse group,  InviteStatus status,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InviteResponse() when $default != null:
return $default(_that.id,_that.from,_that.group,_that.status,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  UserResponse from,  InviteGroupResponse group,  InviteStatus status,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _InviteResponse():
return $default(_that.id,_that.from,_that.group,_that.status,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: '_id')  String id,  UserResponse from,  InviteGroupResponse group,  InviteStatus status,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _InviteResponse() when $default != null:
return $default(_that.id,_that.from,_that.group,_that.status,_that.createdAt);case _:
  return null;
