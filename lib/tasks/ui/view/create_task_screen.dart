...
class CreateTaskScreen extends StatefulWidget {
  const CreateTaskScreen({required this.groupId, super.key});
...
class _CreateTaskScreenState extends State<CreateTaskScreen> {
  ...
  void initState() {
    super.initState();
    bloc.load(groupId: widget.groupId);
  }
      ...
      child: Scaffold(
            ...
            BlocSelector<CreateTaskCubit, CreateTaskState, TaskPriority>(
              ...
              builder:
                  (context, priority) => AnimatedContainer(
                    ...
                    child: Text(priority.title.substring(0, 1), style: TextStyle(color: priority.color, fontWeight: FontWeight.bold)),
                  ),
            ),
        ...
        body: SafeArea(
          child: Column(
            ...
            children: [
              BlocSelector<CreateTaskCubit, CreateTaskState, bool>(
                bloc: bloc,
              ...
              Padding(
                ...
                child: BlocSelector<CreateTaskCubit, CreateTaskState, bool>(
                  ...
                  builder: (context, isEnabled) => FilledButton(onPressed: isEnabled ? bloc.createTask : null, child: const Text('Create Task')),
                ),
              ),
            ],
          ),
