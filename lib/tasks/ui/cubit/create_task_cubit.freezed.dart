...
mixin _$CreateTaskState {
 ...
 bool get isLoading; String get title; TaskPriority get priority; TaskStatus get status; DateTime get date; TimeOfDay get time; Set<String> get assignedIds; String? get description; GroupResponse? get group;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,title,priority,status,date,time,const DeepCollectionEquality().hash(assignedIds),description,group);

@override
String toString() {
  return 'CreateTaskState(isLoading: $isLoading, title: $title, priority: $priority, status: $status, date: $date, time: $time, assignedIds: $assignedIds, description: $description, group: $group)';
}
...
@useResult
$Res call({
 bool isLoading, String title, TaskPriority priority, TaskStatus status, DateTime date, TimeOfDay time, Set<String> assignedIds, String? description, GroupResponse? group
});
...
/// Create a copy of CreateTaskState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? title = null,Object? priority = null,Object? status = null,Object? date = null,Object? time = null,Object? assignedIds = null,Object? description = freezed,Object? group = freezed,}) {
...
as Set<String>,description: freezed == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
...
class _CreateTaskState extends CreateTaskState {
  const _CreateTaskState({required this.isLoading, required this.title, required this.priority, required this.status, required this.date, required this.time, required final  Set<String> assignedIds, this.description, this.group}): _assignedIds = assignedIds,super._();
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,title,priority,status,date,time,const DeepCollectionEquality().hash(_assignedIds),description,group);
...
/// Create a copy of CreateTaskState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? title = null,Object? priority = null,Object? status = null,Object? date = null,Object? time = null,Object? assignedIds = null,Object? description = freezed,Object? group = freezed,}) {
