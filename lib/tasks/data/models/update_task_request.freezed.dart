...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  DateTime dueDate,  TaskPriority priority,  TaskStatus status,  bool completed,  List<String> assignedTo,  List<UpdateTaskChecklistItem> checklist,  bool recurring, @JsonKey(includeIfNull: false)  String? description, @JsonKey(includeIfNull: false)  TaskRecurrence? recurrencePattern, @JsonKey(includeIfNull: false)  DateTime? recurrenceEndDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateTaskRequest() when $default != null:
return $default(_that.title,_that.dueDate,_that.priority,_that.status,_that.completed,_that.assignedTo,_that.checklist,_that.recurring,_that.description,_that.recurrencePattern,_that.recurrenceEndDate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  DateTime dueDate,  TaskPriority priority,  TaskStatus status,  bool completed,  List<String> assignedTo,  List<UpdateTaskChecklistItem> checklist,  bool recurring, @JsonKey(includeIfNull: false)  String? description, @JsonKey(includeIfNull: false)  TaskRecurrence? recurrencePattern, @JsonKey(includeIfNull: false)  DateTime? recurrenceEndDate)  $default,) {final _that = this;
switch (_that) {
case _UpdateTaskRequest():
return $default(_that.title,_that.dueDate,_that.priority,_that.status,_that.completed,_that.assignedTo,_that.checklist,_that.recurring,_that.description,_that.recurrencePattern,_that.recurrenceEndDate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  DateTime dueDate,  TaskPriority priority,  TaskStatus status,  bool completed,  List<String> assignedTo,  List<UpdateTaskChecklistItem> checklist,  bool recurring, @JsonKey(includeIfNull: false)  String? description, @JsonKey(includeIfNull: false)  TaskRecurrence? recurrencePattern, @JsonKey(includeIfNull: false)  DateTime? recurrenceEndDate)?  $default,) {final _that = this;
switch (_that) {
case _UpdateTaskRequest() when $default != null:
return $default(_that.title,_that.dueDate,_that.priority,_that.status,_that.completed,_that.assignedTo,_that.checklist,_that.recurring,_that.description,_that.recurrencePattern,_that.recurrenceEndDate);case _:
  return null;
...
/// Adds pattern-matching-related methods to [UpdateTaskChecklistItem].
extension UpdateTaskChecklistItemPatterns on UpdateTaskChecklistItem {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UpdateTaskChecklistItem value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UpdateTaskChecklistItem() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UpdateTaskChecklistItem value)  $default,){
final _that = this;
switch (_that) {
case _UpdateTaskChecklistItem():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UpdateTaskChecklistItem value)?  $default,){
final _that = this;
switch (_that) {
case _UpdateTaskChecklistItem() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  TaskChecklistItemStatus status,  int order)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateTaskChecklistItem() when $default != null:
return $default(_that.title,_that.status,_that.order);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  TaskChecklistItemStatus status,  int order)  $default,) {final _that = this;
switch (_that) {
case _UpdateTaskChecklistItem():
return $default(_that.title,_that.status,_that.order);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  TaskChecklistItemStatus status,  int order)?  $default,) {final _that = this;
switch (_that) {
case _UpdateTaskChecklistItem() when $default != null:
return $default(_that.title,_that.status,_that.order);case _:
  return null;
