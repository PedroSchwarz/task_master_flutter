...
class _TasksRemoteDataSource implements TasksRemoteDataSource {
  ...
  @override
  Future<List<SimplifiedTaskResponse>> fetchAllAssigned() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Content-Type': 'application/json'};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<SimplifiedTaskResponse>>(
      Options(
            method: 'GET',
            headers: _headers,
            extra: _extra,
  ...
  @override
  Future<List<SimplifiedTaskResponse>> fetchAllOwned() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Content-Type': 'application/json'};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<List<TaskResponse>> fetchUpcoming() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Content-Type': 'application/json'};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<List<TaskResponse>> fetchOverdue() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Content-Type': 'application/json'};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<void> update(String id, UpdateTaskRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Content-Type': 'application/json'};
    _headers.removeWhere((k, v) => v == null);
