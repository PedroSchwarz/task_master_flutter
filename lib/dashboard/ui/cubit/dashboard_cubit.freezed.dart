...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  bool showingProgression,  bool showingHighlights,  GroupsListType groupsListType,  List<GroupResponse> groups,  List<TaskResponse> upcomingTasks,  List<TaskResponse> overdueTasks,  List<InviteResponse> invites,  List<WeeklyTaskProgression?> progression,  TaskProgressionSelection selection,  bool isRefreshing)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DashboardState() when $default != null:
return $default(_that.isLoading,_that.showingProgression,_that.showingHighlights,_that.groupsListType,_that.groups,_that.upcomingTasks,_that.overdueTasks,_that.invites,_that.progression,_that.selection,_that.isRefreshing);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  bool showingProgression,  bool showingHighlights,  GroupsListType groupsListType,  List<GroupResponse> groups,  List<TaskResponse> upcomingTasks,  List<TaskResponse> overdueTasks,  List<InviteResponse> invites,  List<WeeklyTaskProgression?> progression,  TaskProgressionSelection selection,  bool isRefreshing)  $default,) {final _that = this;
switch (_that) {
case _DashboardState():
return $default(_that.isLoading,_that.showingProgression,_that.showingHighlights,_that.groupsListType,_that.groups,_that.upcomingTasks,_that.overdueTasks,_that.invites,_that.progression,_that.selection,_that.isRefreshing);}
}
