...
mixin _$CreateGroupState {
 ...
 List<UserResponse> get users; List<String> get selectedUsersIds; String get name; String get description; bool get showInviteUsersSheet; bool get isLoading; bool get isSubmitting; bool get showDeleteDialog; bool get shouldGoBack; GroupResponse? get group; int? get groupColor;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(users),const DeepCollectionEquality().hash(selectedUsersIds),name,description,showInviteUsersSheet,isLoading,isSubmitting,showDeleteDialog,shouldGoBack,group,groupColor);

@override
String toString() {
  return 'CreateGroupState(users: $users, selectedUsersIds: $selectedUsersIds, name: $name, description: $description, showInviteUsersSheet: $showInviteUsersSheet, isLoading: $isLoading, isSubmitting: $isSubmitting, showDeleteDialog: $showDeleteDialog, shouldGoBack: $shouldGoBack, group: $group, groupColor: $groupColor)';
}
...
@useResult
$Res call({
 List<UserResponse> users, List<String> selectedUsersIds, String name, String description, bool showInviteUsersSheet, bool isLoading, bool isSubmitting, bool showDeleteDialog, bool shouldGoBack, GroupResponse? group, int? groupColor
});
...
/// Create a copy of CreateGroupState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? users = null,Object? selectedUsersIds = null,Object? name = null,Object? description = null,Object? showInviteUsersSheet = null,Object? isLoading = null,Object? isSubmitting = null,Object? showDeleteDialog = null,Object? shouldGoBack = null,Object? group = freezed,Object? groupColor = freezed,}) {
...
as GroupResponse?,groupColor: freezed == groupColor ? _self.groupColor : groupColor // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
/// Create a copy of CreateGroupState
...
/// Adds pattern-matching-related methods to [CreateGroupState].
extension CreateGroupStatePatterns on CreateGroupState {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CreateGroupState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CreateGroupState() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CreateGroupState value)  $default,){
final _that = this;
switch (_that) {
case _CreateGroupState():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CreateGroupState value)?  $default,){
final _that = this;
switch (_that) {
case _CreateGroupState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<UserResponse> users,  List<String> selectedUsersIds,  String name,  String description,  bool showInviteUsersSheet,  bool isLoading,  bool isSubmitting,  bool showDeleteDialog,  bool shouldGoBack,  GroupResponse? group,  int? groupColor)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateGroupState() when $default != null:
return $default(_that.users,_that.selectedUsersIds,_that.name,_that.description,_that.showInviteUsersSheet,_that.isLoading,_that.isSubmitting,_that.showDeleteDialog,_that.shouldGoBack,_that.group,_that.groupColor);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<UserResponse> users,  List<String> selectedUsersIds,  String name,  String description,  bool showInviteUsersSheet,  bool isLoading,  bool isSubmitting,  bool showDeleteDialog,  bool shouldGoBack,  GroupResponse? group,  int? groupColor)  $default,) {final _that = this;
switch (_that) {
case _CreateGroupState():
return $default(_that.users,_that.selectedUsersIds,_that.name,_that.description,_that.showInviteUsersSheet,_that.isLoading,_that.isSubmitting,_that.showDeleteDialog,_that.shouldGoBack,_that.group,_that.groupColor);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<UserResponse> users,  List<String> selectedUsersIds,  String name,  String description,  bool showInviteUsersSheet,  bool isLoading,  bool isSubmitting,  bool showDeleteDialog,  bool shouldGoBack,  GroupResponse? group,  int? groupColor)?  $default,) {final _that = this;
switch (_that) {
case _CreateGroupState() when $default != null:
return $default(_that.users,_that.selectedUsersIds,_that.name,_that.description,_that.showInviteUsersSheet,_that.isLoading,_that.isSubmitting,_that.showDeleteDialog,_that.shouldGoBack,_that.group,_that.groupColor);case _:
  return null;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_users),const DeepCollectionEquality().hash(_selectedUsersIds),name,description,showInviteUsersSheet,isLoading,isSubmitting,showDeleteDialog,shouldGoBack,group,groupColor);
