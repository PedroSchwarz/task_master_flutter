...
@override
int get hashCode => Object.hash(runtimeType,isLoading,const DeepCollectionEquality().hash(tasks),const DeepCollectionEquality().hash(invites),selectedDate,listView,userFilter,completionFilter,statusFilter,priorityFilter,dateSort,prioritySort,shouldGoBack,group,currentUser,userToFilterBy,taskToDelete);

@override
String toString() {
  return 'GroupDetailsState(isLoading: $isLoading, tasks: $tasks, invites: $invites, selectedDate: $selectedDate, listView: $listView, userFilter: $userFilter, completionFilter: $completionFilter, statusFilter: $statusFilter, priorityFilter: $priorityFilter, dateSort: $dateSort, prioritySort: $prioritySort, shouldGoBack: $shouldGoBack, group: $group, currentUser: $currentUser, userToFilterBy: $userToFilterBy, taskToDelete: $taskToDelete)';
}
...
@useResult
$Res call({
 bool isLoading, List<TaskResponse> tasks, List<InviteResponse> invites, DateTime selectedDate, TaskListView listView, TaskUserFilter userFilter, TaskCompletionFilter completionFilter, TaskStatusFilter statusFilter, TaskPriorityFilter priorityFilter, TaskDateSort dateSort, TaskPrioritySort prioritySort, bool shouldGoBack, GroupResponse? group, UserData? currentUser, UserResponse? userToFilterBy, TaskResponse? taskToDelete
});
...
as TaskPrioritySort,shouldGoBack: null == shouldGoBack ? _self.shouldGoBack : shouldGoBack // ignore: cast_nullable_to_non_nullable
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,const DeepCollectionEquality().hash(_tasks),const DeepCollectionEquality().hash(_invites),selectedDate,listView,userFilter,completionFilter,statusFilter,priorityFilter,dateSort,prioritySort,shouldGoBack,group,currentUser,userToFilterBy,taskToDelete);
