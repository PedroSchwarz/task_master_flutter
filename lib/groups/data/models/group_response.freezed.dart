...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  String name,  String description,  DateTime createdAt,  UserResponse owner,  List<UserResponse> members,  int? color)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupResponse() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.createdAt,_that.owner,_that.members,_that.color);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  String name,  String description,  DateTime createdAt,  UserResponse owner,  List<UserResponse> members,  int? color)  $default,) {final _that = this;
switch (_that) {
case _GroupResponse():
return $default(_that.id,_that.name,_that.description,_that.createdAt,_that.owner,_that.members,_that.color);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: '_id')  String id,  String name,  String description,  DateTime createdAt,  UserResponse owner,  List<UserResponse> members,  int? color)?  $default,) {final _that = this;
switch (_that) {
case _GroupResponse() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.createdAt,_that.owner,_that.members,_that.color);case _:
  return null;
