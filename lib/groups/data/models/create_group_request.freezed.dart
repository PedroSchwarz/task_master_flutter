...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String description,  int? color)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateGroupRequest() when $default != null:
return $default(_that.name,_that.description,_that.color);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String description,  int? color)  $default,) {final _that = this;
switch (_that) {
case _CreateGroupRequest():
return $default(_that.name,_that.description,_that.color);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String description,  int? color)?  $default,) {final _that = this;
switch (_that) {
case _CreateGroupRequest() when $default != null:
return $default(_that.name,_that.description,_that.color);case _:
  return null;
