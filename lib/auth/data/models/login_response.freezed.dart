...
@override
String toString() {
  return 'LoginResponse(accessToken: $accessToken, firstName: $firstName, lastName: $lastName, email: $email)';
}
...
class _LoginResponse implements LoginResponse {
  const _LoginResponse({@JsonKey(name: 'access_token') required this.accessToken, required this.firstName, required this.lastName, required this.email});
