...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String firstName,  String lastName,  String email,  String password,  String confirmPassword,  bool hidePassword,  bool isSubmitting,  bool isAuthenticated,  bool emailError,  bool passwordError,  bool confirmPasswordError,  RegisterResult? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RegisterState() when $default != null:
return $default(_that.firstName,_that.lastName,_that.email,_that.password,_that.confirmPassword,_that.hidePassword,_that.isSubmitting,_that.isAuthenticated,_that.emailError,_that.passwordError,_that.confirmPasswordError,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String firstName,  String lastName,  String email,  String password,  String confirmPassword,  bool hidePassword,  bool isSubmitting,  bool isAuthenticated,  bool emailError,  bool passwordError,  bool confirmPasswordError,  RegisterResult? error)  $default,) {final _that = this;
switch (_that) {
case _RegisterState():
return $default(_that.firstName,_that.lastName,_that.email,_that.password,_that.confirmPassword,_that.hidePassword,_that.isSubmitting,_that.isAuthenticated,_that.emailError,_that.passwordError,_that.confirmPasswordError,_that.error);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String firstName,  String lastName,  String email,  String password,  String confirmPassword,  bool hidePassword,  bool isSubmitting,  bool isAuthenticated,  bool emailError,  bool passwordError,  bool confirmPasswordError,  RegisterResult? error)?  $default,) {final _that = this;
switch (_that) {
case _RegisterState() when $default != null:
return $default(_that.firstName,_that.lastName,_that.email,_that.password,_that.confirmPassword,_that.hidePassword,_that.isSubmitting,_that.isAuthenticated,_that.emailError,_that.passwordError,_that.confirmPasswordError,_that.error);case _:
  return null;
